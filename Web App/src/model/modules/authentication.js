...
const module = createReduxModule("authentication", {
  clockNeedsSetup: null,
...
export const clearAuthErrors = module.addReducer(
  "clearAuthErrors",
  (state, payload) => {
...
export const authenticateUser = module.addFetcher(
  "authenticateUser",
  "/api/auth/login",
  {
...
export const reauthenticateUser = module.addFetcher(
  "reauthenticateUser",
  "/api/auth/reauth",
  {
    onSuccess: (state, action) => {
...
export const getAvailableUsers = module.addFetcher(
  "getAvailableUsers",
  "/api/auth/getusers",
  {
    onSuccess: (state, action) => {
...
export const getClockNeedsSetup = module.addFetcher(
  "getClockNeedsSetup",
  "/api/auth/hasusers",
  {
    onSuccess: (state, action) => {
      state.clockNeedsSetup = action.payload.hasUsers == false;
    },
  }
);
