...
export const fetchDisplaySettings = module.addFetcher(
	"fetchDisplaySettings", 
	"/api/settings/getDisplaySettings",
	{
...
export const updateDisplaySettings = module.addFetcher(
	"updateDisplaySettings", 
	"/api/settings/setDisplaySettings",
	{
	  onSuccess: (state, action) => {
